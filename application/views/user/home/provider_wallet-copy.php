                                ...
                                <div class="wallet-details">
                                    ...
                                    <div class="wallet-progress-chart">
                                        ...
                                        <div class="progress mt-1">
                                            <div class="progress-bar bg-theme" role="progressbar" aria-valuenow="41" aria-valuemin="0"
                                                 aria-valuemax="100" style="width:<?= round($total_per); ?>%">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <label
                                                    class="input-group-text display-5"><?= currency_conversion($user_currency_code); ?></label>
                                            </div>
                                            <input type="hidden" id="currency_val" name="currency_val"
                                                   value="<?php echo $user_currency_code; ?>">
                                            <input type="hidden" id="wallet_amount" value="<?php echo (int)$service_amount1; ?>">
                                            <input type="text" maxlength="10" class="form-control isNumber" name="wallet_withdraw_amt"
                                                   id="wallet_withdraw_amt" placeholder="00.00">
                                        </div>
                                    </div>
                                </form>
                                <div class="text-center mb-3">
                                    ...
                                    <ul class="list-inline mb-0">
                                        <li class="line-inline-item mb-0 d-inline-block">
                                            <a href="javascript:;" data-amount="50"
                                               class="updatebtn withdraw_wallet_value"><?= currency_conversion($user_currency_code); ?>50</a>
                                        </li>
                                        <li class="line-inline-item mb-0 d-inline-block">
                                            <a href="javascript:;" data-amount="100"
                                               class="updatebtn withdraw_wallet_value"><?= currency_conversion($user_currency_code); ?>100</a>
                                        </li>
                                        <li class="line-inline-item mb-0 d-inline-block">
                                            <a href="javascript:;" data-amount="150"
                                               class="updatebtn withdraw_wallet_value"><?= currency_conversion($user_currency_code); ?>150</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <a href="javascript:void(0);" id="stripe_withdraw_wallet"
                                   class="btn btn-primary btn-block withdraw-btn">Withdraw</a>
                                <div id="card_form_div">
                                    <div class="payment-card">
                                        <span>Withdraw Amount is</span>
                                        <h3 class="mb-3"><?php echo currency_conversion($user_currency_code); ?><span
                                                id="remember_withdraw_wallet"></span></h3>
