...
// Start benefitpay 
$route['benefitpay_request'] = 'user/Dashboard/benefitpay_request';
$route['benefitpay_response'] = 'user/Dashboard/benefitpay_response';
$route['benefitpay_error'] = 'user/Dashboard/benefitpay_error';
